 ...
 * @brief Defines the CameraComponent used for viewing and projection
 * calculations in the game engine.
 * @author Shaun
 * @date 2025-04-05
 */
 ...
 * @brief Stores camera parameters and provides methods for view and projection
 * matrix calculations.
 */
struct CameraComponent {
  ...
  /**
   * @brief Computes and returns the view matrix based on the camera's current
  ...
  /**
   * @brief Computes and returns the projection matrix using perspective
   * projection.
